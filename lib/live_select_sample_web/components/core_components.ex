defmodule LiveSelectSampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveSelectSampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveSelectSampleWeb.Gettext, "errors", msg, opts)
    end
  end
